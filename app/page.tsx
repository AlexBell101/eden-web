  ...
  return (
    <main className="min-h-screen bg-[#0D0F12] text-[#F5F1EA] flex flex-col">
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 pt-20 pb-24 max-w-4xl mx-auto">
        ...
        <h1
          className="text-5xl sm:text-6xl lg:text-7xl tracking-tight leading-[1.08] mb-6"
          style={{ fontFamily: 'var(--font-serif)' }}
        >
          Stop searching.<br />
          <span className="text-[#7FA36C]">Let Eden find you.</span>
        </h1>

        <p className="text-lg text-[#B7B0A3] leading-relaxed max-w-2xl mb-10">
          Describe the kind of place you want in your own words — calm streets, better light,
          a real kitchen, somewhere your dog will love. Eden scores every listing against your
          standards, so only the homes that truly fit rise to the top.
        </p>
